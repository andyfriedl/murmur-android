...
fun StreamScreen(
    ...
    var autoShownQR by remember { mutableStateOf(false) }
    ...
    LaunchedEffect(isCreator, isFresh) {
        if (isCreator && isFresh) {
            isGeneratingQR = true
            StreamRepository.createInviteId(streamId) { inviteId ->
                isGeneratingQR = false
                if (inviteId != null) {
                    val generated = QRCodeHelper.generateQRCode(inviteId)
                    qrBitmap = generated
                    ...
                    Row(
                        ...
                        Box {
                            ...
                            DropdownMenu(
                                ...
                                if (isCreator) {
                                    DropdownMenuItem(
                                        text = { Text("Delete Stream", style = redStyle) },
            ...
            while (showQR && isActive) {
                ...
                StreamRepository.createInviteId(streamId) { newId ->
                    if (newId != null && showQR) {
                        ...
                        lastInviteId = newId
                        qrBitmap = QRCodeHelper.generateQRCode(newId)
                    }
                }
            }
        }
            ...
            AlertDialog(
                ...
                text = {
                    Column(horizontalAlignment = Alignment.CenterHorizontally) {
                        Text(
                            text = "Share this code with someone to add them to your stream.",
